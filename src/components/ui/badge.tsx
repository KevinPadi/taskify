  ...
  "inline-flex items-center rounded-full border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        low: "bg-green-400 dark:bg-green-500/30 text-green-950 dark:text-green-200 border-none",
        medium: "bg-yellow-300 dark:bg-yellow-300/30 text-yellow-950 dark:text-yellow-400 border-none",
        high: "bg-red-400 dark:bg-red-400/30 text-red-950 dark:text-red-300 border-none",
      },
    },
    defaultVariants: {
      variant: "default",
